...
import { Box, Typography, Card, CardContent, Avatar, Divider, IconButton, Button, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, TextField, Grid } from '@mui/material';
        ...
        <Box sx={{ padding: 3 }}>
            ...
            {profileUser && (
                <Box sx={{ mb: 3, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <Avatar sx={{ bgcolor: '#2196f3', width: 100, height: 100, mb: 2 }}>
                    ...
                    {isEditing ? (
                        ...
                        <>
                            ...
                            {user && user.id === profileUser.id && (
                                <Button variant="outlined" startIcon={<Edit />} onClick={handleEdit} sx={{ mb: 2 }}>
                                    Edit Profile
                                </Button>
                            )}
                            {user && user.id !== profileUser.id && (
                                isFollowing ? (
                                    <Button variant="contained" color="secondary" startIcon={<PersonRemove />} onClick={handleUnfollow}>
                                        Unfollow
                                    </Button>
                                ) : (
                                    <Button variant="contained" color="primary" startIcon={<PersonAdd />} onClick={handleFollow}>
                                        Follow
                                    </Button>
                                )
                            )}
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                            ...
                            {user && (user.id === selectedPost.userId || user.role === 'Admin') && (
                                <>
                                    ...
                                    <IconButton color="secondary" sx={{ padding: '4px' }} onClick={() => handleOpen(selectedPost)}>
                                        <Delete />
                                    </IconButton>
                                </>
                            )}
