...
function EditRewards() {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      rewardName: yup
        ...
        .required("Reward name is needed"),
      description: yup
        .string()
        .trim()
        .min(3, "At least 3 characters")
      ...
      Points: yup
        .number()
        .min(100, "Minimum points 1000")
        .max(100000, "Maximum points 100,000")
        .integer()
  ...
  const formikEdit = useFormik({
    ...
    onSubmit: (data) => {
      ...
      http.put(`/reward/${formikEdit.values.id}`, data).then((res) => {
        console.log(res.data);
      });
    },
  });
  ...
  return (
    <Box>
      <Typography variant="h5" sx={{ margin: "-100px 0px 0px 100px" }}>
        Rewards
      </Typography>
      <TableContainer
        component={Paper}
        sx={{ width: "100%", margin: "30px 0px 0px 100px" }}
      >
