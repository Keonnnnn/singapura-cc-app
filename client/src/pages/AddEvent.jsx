...
import { Box, Typography, TextField, Button, Select, MenuItem, FormControl, InputLabel, Container, Paper } from '@mui/material';
...
function AddEvent() {
    ...
    return (
        <Container maxWidth="lg">
            ...
            <Button variant="outlined" color="secondary" sx={{ display: 'inline-block', float: 'right' }}
